			...
			<view class="hero-bg" :style="{ background: currentGradient }">
				<view class="hero-content">
					...
					<view class="hero-badge">
						<text class="badge-text">🐶 狗狗健康指南</text>
					</view>
				</view>
			</view>
...
<script setup>
	...
	const diseaseInfo = ref({
		...
		causesList: ['病毒感染', '天气变化', '免疫力下降', '接触患病狗狗'],
		treatmentList: [{
				title: '保暖休息',
				desc: '提供温暖的休息环境，避免受凉'
			},
		...
		advice: '如果症状持续超过2天，或出现呼吸困难、拒绝进食、体温超过39°C，请立即就医。'
	})
	...
	const diseaseData = {
		...
		'呕吐': {
			...
			causesList: ['饮食不当', '肠胃炎', '寄生虫', '异物吞食', '应激反应'],
			treatmentList: [{
					title: '禁食休息',
